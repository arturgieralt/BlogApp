...
export default class AuthorizeMiddleware {
    constructor(private RoleService: IRoleService, private TokenService: ITokenService) {

    }

  authorize = (roles: string[] = [], scopes: string[] = TokenFactory.Permissions[Authorization]) => [

...
export class Routes {
  public routes(app: Application,
    ...
    AuthorizeMiddleware: IAuthorizeMiddleware): void {
    ...
    app
      .route('/users')
      .get(AuthorizeMiddleware.authorize(), UsersController.getAll);
    ...
    app
      .route('/user/logout')
      .post(AuthorizeMiddleware.authorize(), UsersController.logout);
    ...
    app
    .route('/user/remove')
    .post(AuthorizeMiddleware.authorize(), UsersController.remove);

    app
    .route('/user/profile')
    .get(AuthorizeMiddleware.authorize(), UsersController.getMyProfile);

    app
    .route('/captcha/verify')
    .post(CaptchaController.verifyToken);
    ...
    app
      .route('/avatar/upload')
      .post(AuthorizeMiddleware.authorize(), FilesController.uploadAvatar)
  }
}
